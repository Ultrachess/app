...
export default () => {
  ...
  const lastStepTimestamp = useAppSelector(
    (state) => state.game.lastStepTimestamp
  );
  ...
  useEffect(() => {
    ...
    if (provider) dispatch(initContracts(provider.getSigner(0), chainId));
  }, [chainId, accounts, error, isActivating, isActive, provider]);
    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenuContent sideOffset={5}>
          ...
          <DropdownMenuItem>Upload Bot</DropdownMenuItem>
