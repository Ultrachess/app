          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="text-left sm:text-left">
              ...
              <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                ...
                {autoBattleEnabled && <div className="mt-2 flex items-center text-sm text-gray-500">
                  <svg
                    className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                ...
                {price > 0 && <div className="mt-2 flex items-center text-sm text-gray-500">
                  <svg
                    className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400"
                    viewBox="0 0 20 20"
                    fill="currentColor"
            ...
            <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
              ...
              {isOwner && (
                <button
                  ...
                  type="button"
                  onClick={() => {
                    dispatch(setSellBotAddress(id));
                    dispatch(setSellBotModal(true));
                  }}
                >
                  {price ? "Update Price" : "Sell"}
                </button>
              )}
