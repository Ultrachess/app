...
export type NoticeQuery = {
  ...
  notice: {
    ...
    input: {
      __typename?: "Input";
      index: number;
      epoch: { __typename?: "Epoch"; index: number };
    };
  };
};
...
export type NoticesByEpochAndInputQuery = {
  __typename?: "Query";
  epoch: {
    __typename?: "Epoch";
    input: {
...
export type NoticesByEpochQuery = {
  __typename?: "Query";
  epoch: {
    __typename?: "Epoch";
    inputs: {
...
export type VouchersByEpochAndInputQuery = {
  __typename?: "Query";
  epoch: {
    __typename?: "Epoch";
    input: {
...
export type VouchersByEpochQuery = {
  __typename?: "Query";
  epoch: {
    __typename?: "Epoch";
    inputs: {
...
export type ReportsByEpochAndInputQuery = {
  __typename?: "Query";
  epoch: {
    __typename?: "Epoch";
    input: {
...
export type ReportsByEpochQuery = {
  __typename?: "Query";
  epoch: {
    __typename?: "Epoch";
    inputs: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "keccak" } },
                {
                  kind: "Field",
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "outputHashesRootHash" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "vouchersEpochRootHash" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "noticesEpochRootHash" },
                      },
                      {
                        kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "keccakInHashesSiblings" },
                      },
                      {
                        kind: "Field",
                        name: {
...
export const NoticesByEpochAndInputDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "noticesByEpochAndInput" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "epoch_index" },
          },
          type: {
            kind: "NonNullType",
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "input_index" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            alias: { kind: "Name", value: "epoch" },
            name: { kind: "Name", value: "epochI" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "index" },
...
>;
export const NoticesByEpochDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "noticesByEpoch" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<NoticesByEpochQuery, NoticesByEpochQueryVariables>;
...
export const VouchersByEpochAndInputDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "vouchersByEpochAndInput" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const VouchersByEpochDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "vouchersByEpoch" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  VouchersByEpochQuery,
  VouchersByEpochQueryVariables
>;
...
export const ReportsByEpochAndInputDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "reportsByEpochAndInput" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  ReportsByEpochAndInputQuery,
  ReportsByEpochAndInputQueryVariables
>;
export const ReportsByEpochDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "reportsByEpoch" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<ReportsByEpochQuery, ReportsByEpochQueryVariables>;
